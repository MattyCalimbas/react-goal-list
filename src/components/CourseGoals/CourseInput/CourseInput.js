...
const CourseInput = props => {
  ...
  // FormControl is using invalid prop to track true/false value of isValid.  If invalid changes to true (isValid), styled component above has callback functions using invalid prop
  return (
